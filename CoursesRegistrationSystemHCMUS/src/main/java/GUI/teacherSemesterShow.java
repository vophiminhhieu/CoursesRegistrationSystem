...
public class teacherSemesterShow extends JPanel {
	...
	private void on() {
		...
		String[] columnName= {"Name","Year","StartDate","EndDate"};
		JTable table = new JTable(semDao.getListSemester(),columnName);
	...
	public teacherSemesterShow(ActionListener obj) {
